package com.example.PrimerTrabajo.operations;
...
import com.example.PrimerTrabajo.database.SQLHelper;
        ...
        try{
            ...
            if (cursor.getCount() > 0){
                ...
                do{
                    ...
                    model = new ContactoModel(id, nombre,  mensaje, estado);
                    list.add(model);
